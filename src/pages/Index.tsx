          ...
          <div className="max-w-md mx-auto space-y-4">
            <div className="relative">
              ...
              <Input
                ...
                disabled={searching}
                className="pl-11 h-12 bg-card border border-border rounded-lg text-sm focus-visible:ring-1 focus-visible:ring-foreground/20 capitalize"
              />
            </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {preview.definition.includes(" | ") || preview.definition.includes("(") ? (
                        ...
                        <p className="text-base leading-relaxed">{preview.definition}</p>
                      )}
                    </div>
                  </div>
                  {preview.example && (
                    <div>
                      ...
                      <p className="text-base italic text-muted-foreground">"{preview.example}"</p>
                    </div>
                  )}
                </div>
              </Card>
