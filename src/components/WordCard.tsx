  ...
  return (
    ...
    >
      <Link to={`/word/${word.id}`}>
        <Card className="bg-card border border-border hover:border-foreground/30 transition-all duration-200 cursor-pointer group relative overflow-hidden h-40">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <div className="space-y-1">
                {word.definition.includes(" | ") || word.definition.includes("(") ? (
                  (() => {
                    const section = word.definition.split(" | ")[0];
